...
class EventController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.events.create', compact('title')); // Show the create event form
    }
    ...
    public function show(Event $event)
    {
        ...
        return view('admin.events.show', compact('event', 'title')); // Show the event details
    }

    public function edit(Event $event)
    {
        $title = "Edit Event - " . $event->title; // Dynamic title for edit page
        return view('admin.events.edit', compact('event', 'title')); // Show the edit form for the event
    }
