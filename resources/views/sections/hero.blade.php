<div style="background-image: url('{{ Storage::url($setting->hero_background) }}');"
    class="bg-cover bg-center min-h-screen object-contain">
    <div class=" bg-black/60 min-h-screen">
        <section class="md:flex justify-between  p-12 md:gap-3">
            <div class=" mt-24 w-full " data-aos="zoom-in-up">
                <h1 class="text-4xl font-bold text-white">{{ $setting->hero_header }} <span
                        class=" font-semibold">{{ $setting->name }}</span></h1>
                <div class="bg-gray-400/50 p-4 rounded">
                    <p class="text-lg text-gray-400 mt-2 ">{!! $setting->hero_subheader !!}</p>
                </div>
                <div class="flex gap-4 mt-4">
                    <a href="{{ $setting->button1_link }}"
                        class="px-4 py-2 text-white bg-accent rounded-md hover:border-white hover:bg-transparent border-2 transition duration-200">{{ $setting->button1_text }}</a>
                    <a href="{{ $setting->button2_link }}"
                        class="px-4 py-2 text-accent hover:bg-white border-2 border-accent  rounded-md  transition duration-200">{{ $setting->button2_text }}</a>
                </div>
            </div>

            <form class="bg-white/50 elevation-5 rounded-lg px-8 pt-6 pb-8 my-4 w-full" method="POST"
                action="{{ route('reservation') }}" data-aos="zoom-in-up">
                @csrf
                ...
                <div>
                    ...
                    <div class="mb-4">
                        <label class="block text-gray-700 text-sm font-bold mb-2" for="phone">Phone
                            Number</label>
                ...
                <div class="mt-6">
                    ...
                    <div class="mb-4">
                        <label class="block text-gray-700 text-sm font-bold mb-2" for="checkIn">Check-in
                            Date</label>
                    ...
                    <div class="mb-4">
                        <label class="block text-gray-700 text-sm font-bold mb-2" for="checkOut">Check-out
                            Date</label>
                    ...
                    <div class="mb-4">
                        <label class="block text-gray-700 text-sm font-bold mb-2" for="guests">Number of
                            Guests</label>
