...
<body class="bg-gray-100 font-sans antialiased">
    <div class="max-w-xl mx-auto bg-white shadow-lg rounded-lg overflow-hidden my-10">
        <div class="bg-green-800 px-6 py-4">
            ...
            <div class="text-green-200 italic"> Please make payment as soon as possile because this reservation will Timed Out in 2 Hours</div>
        </div>
        ...
        <div class="px-6 py-6">
            ...
            <p class="text-gray-700 mb-4">
                We are thrilled to confirm your reservation at <span class="font-semibold">
                    {{ $settings->name }}</span>. Here are
            ...
            <p class="text-gray-700 mb-4">
                We look forward to welcoming you to {{ $settings->name }}. Should you have any special requests
                or need
                assistance, feel free to reach out to us at <a href="mailto: {{ $contact->email }}"
                    class="text-teal-600 hover:underline"> {{ $contact->email }}</a> or call us at
                {{ $contact->phone }}.
            </p>
