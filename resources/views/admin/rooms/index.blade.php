...
@section('content')
    <div class="p-6">
        ...
        <!-- Add Room Button -->
        <div class="mb-4">
            <a href="{{ route('admin.rooms.create') }}" class="bg-primary text-white px-4 py-2 rounded-lg hover:bg-primary-dark transition">
                Add New Room
            </a>
        </div>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Room Title</th>
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                @foreach ($room->amenities as $amenity)
                                    <span class=" bg-gray-200 rounded-full px-2 m-2 py-1 text-xs font-semibold text-gray-700 block">{{ $amenity }}</span>
                                @endforeach
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-right">
                                <a href="{{ route('admin.rooms.show', $room->id) }}" class="text-gray-600 hover:text-gray-900"><i class="fas fa-eye"></i></a>
                                <a href="{{ route('admin.rooms.edit', $room->id) }}" class="text-blue-600 hover:text-blue-900"><i class="fas fa-edit"></i></a>
