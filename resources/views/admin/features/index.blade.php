    ...
    <div class="container mx-auto py-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            @foreach ($features as $feature)
                <div>
                    <div class="bg-white shadow-md rounded-t-lg overflow-hidden">
                        <!-- Feature Title -->
                        <div class="p-4">
                            <h3 class="text-xl font-semibold text-gray-800 mb-2">{{ $feature->title }}</h3>
                            <p class="text-gray-600 text-sm">{{ Str::limit(strip_tags($feature->description), 220, '...') }}
                            </p>
                        </div>
                    </div>

                    <!-- Action Icons -->
                    <div class="flex space-x-5 items-center px-4 py-2 bg-gray-100 border-t rounded-b-lg">
                        <!-- View Icon -->
